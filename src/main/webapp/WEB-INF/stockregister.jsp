...
<body>
    ...
    <div class="container">
        <form id="registrationForm" action="savestock" method="post">
            <table>
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="input" type="text" id="bloodbankId" name="bloodbankId" required>
                ...
                <tr>
                    ...
                    <td>
                        <input class="input" type="tel" id="phoneNo" name="phoneNo" required>
